Prenons une ligne de code simple en C# qui serait dans une fonction :
...
- exemple 1 : "5" => cette valeur peut être dans la langue française ou anglais, il ne faut pas la traduire. De plus, vous savez ce que ça veut dire.

- exemple 2 : "int" => ce mot ne vient pas du français, donc il faut la traduire.

- exemple 3: "Vector2" => cette expression mathématique n'est pas simple, donc il faut aller se renseigner.
...
Question : Marc-Alexandre, mais alors qu'est-ce "int" en anglais?

- Selon Microsoft learn, par la recherche "c# int français", cela signifie les types numériques intégraux.
...
- Résumé de prof : déclare une variable entière d'une valeur de 5
